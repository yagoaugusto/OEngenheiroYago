...
$pedidos = Compras::listar_pedidos();
?>
<body>
    ...
    <div class="container-fluid page-body-wrapper">
      <div class="main-panel">
        <div class="content-wrapper pb-0">
          ...
          <div class="page-header flex-wrap">
            <h3 class="page-title">Novo pedido de compra</h3>
                    ...
                    <tbody>
                      <?php foreach($pedidos as $x): ?>
                        <tr>
                          ...
                          <td><?= $x['desc_necessidade']; ?></td>
                          <td><?= $x['projeto']; ?></td>
                          <td><?= $x['solicitante']; ?></td>
                          <td><?= data($x['prazo_recebimento']); ?></td>
                          <td><?= $x['situacao']; ?></td>
                          <td>
                            <a href="compras-add-itens-pedido.php?pedido=<?= $x['id'] ?>" class="btn btn-outline-info btt" style="width: 100%;">Abrir pedido</a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
